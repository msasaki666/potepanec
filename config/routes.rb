Rails.application.routes.draw do
  ...
  # If you would like to change where this engine is mounted, simply change the :at option
  # to something different.
  #
  # We ask that you don't use the :as option here, as Solidus relies on it being
